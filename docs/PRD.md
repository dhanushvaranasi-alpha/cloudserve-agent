...
| Classification precision | N/A | 85%+ |
| Citation accuracy | N/A | 95%+ |
| Latency, p95 | N/A | Under 3s |
| Private data occurrences | N/A | Zero |
| Cross-group variation | N/A | Under 5 points |
| Confidence calibration gap | N/A | Within 5 points |
